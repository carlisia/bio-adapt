...
type ConvergenceMonitor struct {
	...
	targetState   core.State  // Target we're converging to
...
// NewConvergence creates a monitor for tracking convergence.
func NewConvergence(target core.State, convergenceThreshold float64) *ConvergenceMonitor {
